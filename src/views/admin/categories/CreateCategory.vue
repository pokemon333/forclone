...
<template>
      <div class="w-1/2 mx-auto mt-8 bg-gray-100">
            <form @submit.prevent="createFunction" class="flex flex-col">
                ...
                <div>
                  <router-link to="/admin/categories"  class="w-1/6 px-6 cursor-pointer py-1.5 m-2 ml-4 text-sm font-bold text-white bg-gray-500 rounded right-4 top-10 hover:bg-gray-700"  >back</router-link>
